...
var ServerList = []string{
	...
	"https://repository.int.otc.fts.d-3.de/api/v1",
	// prod environment
	"https://trustspaces.d-velop/api/v1",
}
...
type SDKOption func(*TlanTrustSpaces)
...
func New(opts ...SDKOption) *TlanTrustSpaces {
	sdk := &TlanTrustSpaces{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "3.1.1",
			GenVersion:        "2.263.3",
			UserAgent:         "speakeasy-sdk/go 3.1.1 2.263.3 1.0.0 tlan-trust-spaces",
			Hooks:             hooks.New(),
		},
	}
